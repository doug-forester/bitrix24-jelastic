...
$biznetFile = 'bitrix_biznet.tar.gz';
$biznetLoc = '/home/source/';
$biznet = '/home/source/bitrix_biznet.tar.gz';
...
if ($short = (getenv('BITRIX_ENV_TYPE') == 'tst'))
{
        $arEditions = array(
                'ru' => array(
                        array(
        ...
        $arEditions = array(
                ...
                'en' => array(
                        ...
                        array(
                                'NAME' => 'Bitrix24',
                                'LIST' => array(
                                		'portal/bitrix24_shop' => 'Store + CRM',
                                        'portal/en_bitrix24' => 'Business',
                                        'portal/en_bitrix24_enterprise' => 'Enterprise'
                                ),
                        ),
                        array(
                                'NAME' => 'BizNet: Business Solutions',
                                'LIST' => array(
                                        'edu/eduportal' => 'Educational Institution Portal',
                                ),
                        ),
                )
        );
...
// Custom function to load Biznet Source
function GetBiznet()
{
	$biznet = '/home/source/bitrix_biznet.tar.gz';

	if( !copy($biznet, $_SERVER['DOCUMENT_ROOT'].'/bitrix_biznet.tar.gz') ) {  
    	echo "Biznet file can't be copied! \n";  
	}  
	else {  
    	echo "Biznet file has been copied! \n";
    
    	$oArchiver = new CArchiver($_SERVER["DOCUMENT_ROOT"]."/".$biznetFile, true);
        $tres = $oArchiver->extractFiles($_SERVER["DOCUMENT_ROOT"]);
    	echo $tres;
    	echo "Biznet file has been extracted \n";
	}
}
