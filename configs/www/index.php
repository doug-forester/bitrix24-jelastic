...
if (LANG == 'ru')
{
	...
	$msg['test'] = "Test servers configuration";
	$msg['crm_title'] = "Бизнес работает в ";
}
else
{
	$msg['hello'] = "Welcome!";
	$msg['title'] = "Welcome to the<br>BizNet Installation Appliance!";
	$msg['desc'] = "This system is optimally configured and is ready to be<br/>used with \"BizNet Site Manager\" and \"BizNet Bitrix24\".<br>";
	$msg['setup'] = "Install";
	$msg['restore'] = "Restore from the backup";
	$msg['test'] = "Test servers configuration";
	$msg['crm_title'] = "Your company. United.";
}
$isCrm = getenv('BITRIX_ENV_TYPE') == '';
?>
<html>
<head>
			...
			<div class="content-container">
				...
				<div class="content-block">
					...
					<div style="text-align: left;">
						<a href="restore.php?lang=<?=$lang?>" class="lnk"><?=$msg['restore']?></a><br/>
                    	<a href="bitrixservertest.php?lang=<?=$lang?>" class="lnk"><?=$msg['test']?></a>
					</div>
